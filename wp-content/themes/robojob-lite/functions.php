...
if ( ! function_exists( 'robojob_lite_admin_notice' ) ) {
    function robojob_lite_admin_notice() {
        ?>
        <div class="notice notice-success is-dismissible">
            <p><strong><a href="<?php echo esc_url('https://codethemes.co/product-category/themes/?utm_source=wporg&utm_campaign=robojoblite');?>"><?php esc_html_e( 'On the occasion of Resortica Lite reaching 20,000+ active installs, get $10 off on all our Premium Themes', 'robojob-lite' ); ?></a></strong></p>
        </div>
        <?php
    }
    add_action( 'admin_notices', 'robojob_lite_admin_notice' );
}